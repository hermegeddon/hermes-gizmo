...
HYDRATE_TOOL_NAME = "gizmo_hydrate_tools"
HYDRATE_REQUEST_MARKER = "gizmo_hydrate_tools_requested"
SAFETY_TOOL_NAMES = ("gizmo_request_full_tools", HYDRATE_TOOL_NAME)
...
def compact_catalog(schemas: Iterable[Schema], cfg: GizmoConfig) -> list[CompactTool]:
...
def render_compact_catalog(tools: list[CompactTool]) -> str:
    lines = [
        "Experimental Gizmo two-pass mode is active.",
