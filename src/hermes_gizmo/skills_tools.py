...
def gizmo_skill_search(args: dict, **kwargs: Any) -> str:
...
def gizmo_skill_details(args: dict, **kwargs: Any) -> str:
...
def gizmo_visible_skill_pins(args: dict, **kwargs: Any) -> str:
...
def gizmo_clear_visible_skill_pins(args: dict, **kwargs: Any) -> str:
...
def gizmo_request_full_skill_index(args: dict, **kwargs: Any) -> str:
